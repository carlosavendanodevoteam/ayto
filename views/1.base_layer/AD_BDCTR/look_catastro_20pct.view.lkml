# The name of this view in Looker is "Look Catastro 20pct"
view: look_catastro_20pct {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `AD_BDCTR.look_catastro_20pct` ;;
  ...
  dimension: num_habitantes {
    type: number
    sql: ${TABLE}.num_habitantes ;;
  }

  dimension: num_mascotas {
    type: number
    sql: ${TABLE}.num_mascotas ;;
  }
  ...
  dimension: valor_catastral {
    type: number
    sql: ${TABLE}.VALOR_CATASTRAL ;;
  }

  dimension: valor_catastral_ranking_v2 {
    type: number
    sql: ${TABLE}.valor_catastral_ranking_v2 ;;
  }
  measure: count {
    type: count
  }
